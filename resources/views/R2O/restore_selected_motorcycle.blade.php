...
@section('main_content')
    <div class="p-4">
        ...
        <div class="col-md-12">
            ...
            <form action="/update_location_for_selected_motorcycle" method="post">
                @csrf
                <table class="table table-hover table table-bordered">
                    ...
                    <tr>
                      <th scope="row">{{ $selected_motorcycles->id}}</th>
                        ...
                        <td><select class="form-select" id="location_id" name="location_id">
                                <option selected>Choose right location for wrongly selected motorcycle</option>
                ...
                <input type="hidden" id="motorcycle_certificate" name="motorcycle_certificate" value="{{$selected_motorcycles->motorcycle_certificate}}">
                <input type="hidden" id="motorcycle_registration_number" name="motorcycle_registration_number" value="{{$selected_motorcycles->motorcycle_registration_number}}">
                <input type="hidden" id="brand" name="brand" value="{{$selected_motorcycles->brand}}">
                <input type="hidden" id="motorcycle_type" name="motorcycle_type" value="{{$selected_motorcycles->motorcycle_type}}">
