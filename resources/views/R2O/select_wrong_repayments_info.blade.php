    ...
    <script>
        ...
        for (var i = 0; i < tr.length; i++) {
            ...
            for (var j = 6; j < td.length; j++) {
                ...
                } else if (parseInt(td[j].innerText) === 3) {
                    td[j].innerHTML = 'Delay'
                    tr[i].style.backgroundColor = "orange"
                    tr[i].style.color = "white"
                } else if (parseInt(td[j].innerText) === 4) {
                    td[j].innerHTML = 'Returned motorcycle'
                    tr[i].style.backgroundColor = "black"
                    tr[i].style.color = "white"
                } else if (parseInt(td[j].innerText) === 5) {
                    td[j].innerHTML = 'NOT Returned motorcycle'
