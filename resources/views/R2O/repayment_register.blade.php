...
<div class="p-4">
 <nav class="navbar navbar-dark bg-primary">
  ...
  @endif
  <br>
<div class="p-1 mt-2 mb-2 bg-secondary text-white">#1 Application Info</div>
    <form action="/edit_company" method="post">
        @csrf
        <div class="card-body">
            <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
            <button id="calculation_4" type="submit" class="btn btn-primary">Edit Company Info</button>
        </div>
    </form>
      <table class="table table-hover table table-bordered">
        <thead>
    ...
    <form action="/edit_application" method="post">
        ...
        <div class="card-body">
            <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
            <button id="calculation_4" type="submit" class="btn btn-primary">Edit Application Info</button>
        </div>
    </form>
  <table class="table table-hover table table-bordered">
    <thead>
    ...
    <form action="/restore_selected_motorcycle" method="post">
        ...
        <div class="card-body">
            <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
            <button id="calculation_4" type="submit" class="btn btn-primary">Edit Motorcycle Info</button>
        </div>
    </form>
  <table class="table table-hover table table-bordered">
    <thead>
    ...
    <form action="/edit_plan" method="post">
        ...
        <div class="card-body">
            <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
            <button id="calculation_4" type="submit" class="btn btn-primary">Edit Plan Info</button>
        </div>
    </form>
  <table class="table table-hover table table-bordered" >
    <thead>
    ...
    <button id="calculation_3" type="button" class="btn btn-outline-info">Repayment Schedule Calculation</button><br>
  <div id="hidden1">
