        ...
        <div class="col-md-6">
                ...
                <form action="/update_motorcycle_info" method="POST" class="needs-validation">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="unit_id" name="unit_id" placeholder="Honda/xxx/11111(Motorcycle_certificate)"  required value="{{$motorcycle->unit_id}}" is-invalid　required>
                    </div>
                    <div class="col-md-6">
                        <label for="inputprice" class="form-label" >Price</label>
                        <input type="price" class="form-control" id="inputprice" name="price" placeholder="60000" required value="{{$motorcycle->price}}" is-invalid>
                    </div>
                    <div class="col-md-6">
                        <label for="inputphone_number" class="form-label">Motorcycle_certificate</label>
                        <input type="text" class="form-control" id="motorcycle_certificate" name="motorcycle_certificate" value="{{$motorcycle->motorcycle_certificate}}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="inputmotorcycle_registration_number" class="form-label">Motorcycle_registration_number</label>
                        <input type="text" class="form-control" id="inputCity" name="motorcycle_registration_number" value="{{$motorcycle->motorcycle_registration_number}}"required>
                    </div>
                    <div class="col-md-6">
