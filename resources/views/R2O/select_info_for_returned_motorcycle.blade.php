           ...
           <form action="/update_info_for_returned_motorcycle" method="POST" class="needs-validation">
               <table class="table table-hover">
                  ...
                  <tr>
                      ...
                      <td>
                          <input type="text" id='price' name="price" value="{{$motorcycles->price}}" required>
                      </td>
                      <td>
                      ...
                      <input type="hidden" id="motorcycle_certificate" name="motorcycle_certificate" value="{{$motorcycles->motorcycle_certificate}}">
                      <input type="hidden" id="motorcycle_registration_number" name="motorcycle_registration_number" value="{{$motorcycles->motorcycle_registration_number}}">
                      <input type="hidden" id="brand" name="brand" value="{{$motorcycles->brand}}">
                      <input type="hidden" id="motorcycle_type" name="motorcycle_type" value="{{$motorcycles->motorcycle_type}}">
                  </tbody>
               </table>
