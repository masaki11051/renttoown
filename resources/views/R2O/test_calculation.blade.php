    ...
    <div class="p-4">
        ...
        <div class="col-md-6">
            <form class="row g-3 needs-validation" novalidate>
                ...
                <input id="start_date" type="date" class="form-control" id="start_date" name="start_date"
                       placeholder="YYYY-MM-DD" required value="{{ old('start_date') }}" min="2022-01-01"
                       max="2080-12-31" is-invalid　required>
        </div>
        <br>
        <div class="col-md-6">
            <label for="inputprice" class="form-label">Price</label>
            <input id="price" type="price" class="form-control" name="price" placeholder="60000" required
                   value="{{ old('price') }}" is-invalid　required>
        </div>
        <br>
        ...
        <div>
            ...
            <button id="calculation_1" 　type="button" class="btn btn-outline-danger">Repayment Amount Calculation
            </button>
            <!--<button id="calculation_2"　type="button" class="btn btn-outline-warning">First Payment Amount Calculation</button>-->
            <button id="calculation_3" 　type="button" class="btn btn-outline-info">Repayment Schedule Calculation
            </button>
            <div id="hidden1">
