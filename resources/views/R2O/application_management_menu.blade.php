    ...
    <div class="p-4">
        ...
        <div class="d-flex position-relative m-3">
            ...
            <div>
                ...
                <p>Add new information such as start date, Motorcycle, plan and so on on the registered customer
                    info </p>
        ...
        <div class="d-flex position-relative m-3">
            ...
            <div>
                ...
                <p>After above "When motorcycle's delivery date fixed" inputted and confirmed if inputted info is
                    right </p>
        ...
        <div class="d-flex position-relative m-3">
            ...
            <div>
                ...
                <a href="{{ url('/customer_search_for_supplementalDocs') }}" class="stretched-link">Upload supplemental
                    Docs</a>
            </div>
        </div>
        <div class="d-flex position-relative m-3">
            <img src="/images/returnOrlost.jpg" style="width: 9rem;height: 9rem" class="flex-shrink-0 me-3" alt="...">
            <div>
                <h5 class="mt-0">When a motorcycle is returned or lost from the customer </h5>
                <p>Upload motorcycle info/location</p>
                <a href="{{ url('/return_or_lost_motorcycle_menu') }}" class="stretched-link">Update Motorcycle
                    info</a>
            </div>
        </div>
        <div class="d-flex position-relative m-3">
