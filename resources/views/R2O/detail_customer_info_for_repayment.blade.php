...
@section('main_content')
    <div class="p-4">
        ...
        <form action="/edit_company_before_registrating_repayments" method="post">
            @csrf
            <div class="card-body">
        ...
        <form action="/edit_application_before_registrating_repayments" method="post">
            @csrf
            <div class="card-body">
                <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
        ...
        <form action="/restore_selected_motorcycle_before_registrating_repayments" method="post">
            @csrf
            <div class="card-body">
                <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
        ...
        <form action="/edit_plan_before_registrating_repayments" method="post">
            @csrf
            <div class="card-body">
                <input type="hidden" id="customer_id" name="customer_id" value="{{$data->id}}">
        ...
        <form action="/register_repayment_info" method="post" name="myForm">
            ...
            <button id="calculation_1" type="button" class="btn btn-outline-danger">Repayment Amount/schedule
                Calculation
            </button>
